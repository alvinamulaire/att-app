...
public class ReturnMaterialInfo extends BaseInfo {
    ...
    private ReturnMaterialResponse returnMaterialResponse;
    private ReturnMaterialResponse issueMaterialResponse;
    ...
    public ReturnMaterialResponse getReturnMaterialResponse() {
        return returnMaterialResponse;
    }

    public void setReturnMaterialResponse( ReturnMaterialResponse returnMaterialResponse ) {
        this.returnMaterialResponse = returnMaterialResponse;
    }

    public ReturnMaterialResponse getIssueMaterialResponse() {
        return issueMaterialResponse;
    }

    public void setIssueMaterialResponse( ReturnMaterialResponse issueMaterialResponse ) {
        this.issueMaterialResponse = issueMaterialResponse;
    }
