sap.ui.define(
  [
    ...
    "att/view/shippingReport/shippingReportApi",
  ],
  function (BaseController, TableSelectDialog) {
     ...
     */
    return BaseController.extend("att.view.shippingReport.shippingReport", {
      onInit: function () {
        this.attachPatternMatched("shippingReport", this.onRouteMatched);
      },
      ...
      openDialog: function (oEvent) {
        ...
        if (id.includes("pallet")) {
          this.isEmpty(oData.shopOrder, "shippingReport.label2")

          $shippingReport.getPallet(
            {
              site: oData.site,
              shopOrder: oData.shopOrder,
            },
      ...
      minus: function () {
        ...
        } else this.error(i18n.getText("shippingReport.warning1"))
      },
      // 匯出
      export: function () {
        let me = this;
        ...
        this.fw_checkEmpty([oData.tableLists], ["shippingReport.warning2"])

        // 取得模板資料
        $shippingReport.getExcel(
          oData.tableLists,
          (res) => {
            if (res) {
              // 解碼
